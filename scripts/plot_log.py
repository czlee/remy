...
ratrunner_group = parser.add_argument_group("rat-runner arguments", "Only used when --remycc is used")
ratrunner_group.add_argument("-s", "--nsenders", type=int, default=2,
    help="Number of senders")
ratrunner_group.add_argument("-p", "--link-ppt", type=float, default=3.1622776601683795,
    help="Link speed (packets per millisecond)")
ratrunner_group.add_argument("-t", "--delay", type=float, default=150.0,
    help="Delay (milliseconds)")
ratrunner_group.add_argument("-q", "--mean-on", type=float, default=1000.0,
    help="Mean on duration (milliseconds)")
ratrunner_group.add_argument("-w", "--mean-off", type=float, default=1000.0,
    help="Mean off duration (milliseconds)")
ratrunner_group.add_argument("-b", "--buffer-size", type=str, default="inf",
    help="Buffer size, a number or 'inf' for infinite buffers")
ratrunner_group.add_argument("-i", "--interval", type=float, default=0.1,
    help="Logging interval (seconds)")
ratrunner_group.add_argument("-T", "--sim-time", type=float, default=100,
...
if not data.run_data:
    ...
    print("Running rat-runner to produce " + datafile)
    runner = RatRunnerRunner(**parameters)
